 ...
 *     @name jquery.waves
 */
if (!window.jQuery) console.error('Waves required jQuery.');else {
  (function ($) {
    $.fn._wave = function (x, y) {
      var _color = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;

      var _opacity = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
  ...
  $(document).ready(function () {
    $('.waves-effect').each(function () {
      $(this).click(function (event) {
        ...
        $(this)._wave(event.pageX - this.offsetLeft, event.pageY - this.offsetTop, _color, _opacity, _duration, _handler);
      });
    });
  });
}